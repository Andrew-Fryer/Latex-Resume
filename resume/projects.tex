  ...
  \cventry
    ...
    {Kingston, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        ...
        \item{Wrote firmware for custom hardware in \textbf{Rust} that processed sensor data into pose estimate for robot.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Winnipeg, Manitoba, Canada} % Location
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        ...
        \item{Placed \textbf{1st} at \href{https://quengcomp.ca/}{QEC (Queen's)}, \textbf{2nd} at \href{https://www.oec2020.ca/}{OEC (Ontario)}, and \textbf{3rd} at \href{https://cfes.ca/cec/}{CEC} by creating and presenting solutions.} % and optimizing?
      \end{cvitems}
    }
