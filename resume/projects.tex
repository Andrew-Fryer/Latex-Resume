  ...
  \cventry
    ...
    {Kingston, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        ...
        \item{Analysed design alternatives and tradeoffs for a pose estimation system for the Queen's VexU robotics team}
  ...
  \cventry
    ...
    {Winnipeg, Manitoba, Canada} % Location
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        ...
        \item{\textbf{Placed 3rd} by creating and presenting a software solution from problem definition to final results}
