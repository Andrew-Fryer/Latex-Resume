  ...
  \cventry
    ...
    {Kingston, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item{Implemented various features (debug REPL, encryption in configuration files)} %encryption in configuration process}
  ...
  \cventry
    ...
    {Kingston, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item{Completed \textbf{6 paid contracts} for \textbf{5 clients} building \textbf{4 apps} using \textbf{MySQL}, \textbf{MongoDB}, \textbf{JavaScript}, \textbf{Python}}
