...
%---------------------------------------------------------
  \cventry
    {Junior Computer Network Security Engineer} % Job title
    {Department of National Defence (contractor through Calian)} % Organization
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item{Worked on several product engineering teams, contributing to \textbf{Java} back-ends using \textbf{Bash}, \textbf{Git}, and \textbf{Docker}}
