  ...
  \cventry
    ...
    {Ottawa, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item{Evaluated exploitability of bugs; used \textbf{C}, \textbf{Frida}, \textbf{IDA Pro}, \textbf{gdb}, \textbf{Windbg} on Linux and Windows}
  ...
  \cventry
    ...
    {Kingston, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item{Implemented and debugged various features (debug REPL, encryption in configuration files)} %encryption in configuration process}
  ...
  \cventry
    ...
    {Kingston, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item{Designed and led teams building \textbf{4 apps} using \textbf{HTML}, \textbf{React}, \textbf{JavaScript}, \textbf{NodeJS}, \textbf{Python}, \textbf{MySQL}, \textbf{Mongo}}
