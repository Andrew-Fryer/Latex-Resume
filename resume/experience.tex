  ...
  \cventry
    ...
    {Kingston, Ontario, Canada} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item{Built grammar-based mutational binary \href{https://en.wikipedia.org/wiki/Fuzzing}{fuzz testing} prototype (automates \textbf{software vulnerability discovery})} % using higher-order function composition}
